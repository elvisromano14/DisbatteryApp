...
(function (d) {
    ...
    d.extend(n.prototype, {
            ...
            for (var h = 0, k = b.length; h < k; h++) {
                ...
                if (r)
                    if (d.isArray(r)) this._expandButton(a, r, c, e);
                        ...
                        l &&
                            (e !== p ? (a.splice(e, 0, l), e++) : a.push(l),
                            l.conf.buttons && ((l.collection = d("<" + this.c.dom.collection.tag + "/>")), (l.conf._collection = l.collection), this._expandButton(l.buttons, l.conf.buttons, !0, e)),
                            r.init && r.init.call(g.button(l.node), g, d(l.node), r),
                            f++);
                    }
            }
        },
                    ...
                    for (var g = 0, f = e.length; g < f; g++) {
                        ...
                        h.key &&
                            (h.key === a
                                ...
                                : !d.isPlainObject(h.key) ||
                                  h.key.key !== a ||
                                  (h.key.shiftKey && !b.shiftKey) ||
                                  (h.key.altKey && !b.altKey) ||
                                  (h.key.ctrlKey && !b.ctrlKey) ||
                                  (h.key.metaKey && !b.metaKey) ||
                                  ((b._buttonsHandled = !0), d(k).click()));
        ...
        _popover: function (a, b, c) {
            var e = this.c,
                ...
                f = b.node(),
                h = function () {
                    d(".dt-button-collection")
                        .stop()
                        .fadeOut(g.fade, function () {
                            d(this).detach();
                        });
    ...
    n.background = function (a, b, c, e) {
        ...
        e || (e = t.body);
        a
            ? d("<div/>").addClass(b).css("display", "none").insertAfter(e).stop().fadeIn(c)
            : d("div." + b)
                  .stop()
                  .fadeOut(c, function () {
    ...
    n.instanceSelector = function (a, b) {
        ...
        var c = [],
            ...
            g = function (a) {
                if (d.isArray(a)) for (var f = 0, k = a.length; f < k; f++) g(a[f]);
    ...
    n.buttonSelector = function (a, b) {
        for (
            var c = [],
                e = function (a, b, c) {
                    for (var d, g, f = 0, k = b.length; f < k; f++) if ((d = b[f])) (g = c !== p ? c + f : f + ""), a.push({ node: d.node, name: d.conf.name, idx: g }), d.buttons && e(a, d.buttons, g + "-");
                },
                g = function (a, b) {
                    var f,
                        h = [];
                    ...
                    if (d.isArray(a) || a instanceof d) for (k = 0, f = a.length; k < f; k++) g(a[k], b);
                    else if (null === a || a === p || "*" === a) for (k = 0, f = h.length; k < f; k++) c.push({ inst: b, node: h[k].node });
                    else if ("number" === typeof a) c.push({ inst: b, node: b.s.buttons[a].node });
                    else if ("string" === typeof a)
                        if (-1 !== a.indexOf(",")) for (h = a.split(","), k = 0, f = h.length; k < f; k++) g(d.trim(h[k]), b);
                        else if (a.match(/^\d+(\-\d+)*$/))
                            (k = d.map(h, function (a) {
                                return a.idx;
                            })),
                                c.push({ inst: b, node: h[d.inArray(a, k)].node });
                        else if (-1 !== a.indexOf(":name")) for (a = a.replace(":name", ""), k = 0, f = h.length; k < f; k++) h[k].name === a && c.push({ inst: b, node: h[k].node });
                        else
                            d(k)
                                .filter(a)
                                .each(function () {
    ...
    n.defaults = {
        ...
        dom: {
            ...
            button: { tag: "ActiveXObject" in u ? "a" : "button", className: "dt-button", active: "active", disabled: "disabled" },
