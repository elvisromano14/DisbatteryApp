...
(function (f) {
    "function" === typeof define && define.amd
        ...
        ? (module.exports = function (g, p, z, t) {
              g || (g = window);
        ...
        f.each(b, function (b, c) {
            if (f.isPlainObject(c)) (b = a.folder(b)), E(b, c);
                ...
                if (y) {
                    ...
                    e = 0;
                    for (m = h.length; e < m; e++) (k = c.createAttribute(h[e].name.replace(":", "_dt_b_namespace_token_"))), (k.value = h[e].value), d.setAttributeNode(k);
                }
    ...
    v.ext.buttons.excelHtml5 = {
        ...
        action: function (a, b, d, c) {
            ...
            a = {
                ...
                xl: { _rels: { "workbook.xml.rels": a("xl/_rels/workbook.xml.rels") }, "workbook.xml": a("xl/workbook.xml"), "styles.xml": a("xl/styles.xml"), worksheets: { "sheet1.xml": h } },
                        ...
                        g ||
                            ("number" === typeof a[b] || (a[b].match && a[b].match(/^-?\d+(\.\d+)?$/) && !a[b].match(/^0\d+/))
                                ...
                                : ((l = l.replace ? l.replace(/[\x00-\x09\x0B\x0C\x0E-\x1F\x7F-\x9F]/g, "") : l),
                                  (g = r(h, "c", { attr: { t: "inlineStr", r: k }, children: { row: r(h, "is", { children: { row: r(h, "t", { text: l, attr: { "xml:space": "preserve" } }) } }) } }))));
                        v.appendChild(g);
                    }
                    m.appendChild(v);
                    e++;
            ...
            c.autoFilter &&
                ...
                f("definedNames", q).append(r(q, "definedName", { attr: { name: "_xlnm._FilterDatabase", localSheetId: "0", hidden: 1 }, text: G(c) + "!$A$" + d + ":" + A(k.header.length - 1) + t })));
